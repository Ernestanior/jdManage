...
<head>
    <style type="text/css">
        ...
        .header-1 {
            ...
            height: 80px;
            background: -webkit-linear-gradient(-45deg, #0452a5 0%, #0053a7 50%, #2d60d8 79%, #4779f3 100%);
            background: -webkit-linear-gradient(315deg, #0452a5 0%, #0053a7 50%, #2d60d8 79%, #4779f3 100%);
...
<body>
    <div class="page">
        <div class="header-1">
            <div class="container">
                <span class="logo">Privacy Policy for Edgejoint</span>
            </div>
        </div>
        <div class="subnav">
            <div class="container">
                ...
                <div id="md_en" data-target="out_en" class="agreement_md">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                this Agreement) refers to Edgejoint.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Edgejoint, accessible from <a
                                    href="https://console.edgejoint.com" rel="external nofollow noopener"
                                    target="_blank">https://console.edgejoint.com</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects
                            ...
                            "Where can I change the settings for disabling, or deleting local shared objects?" available
                            at <a
                    ...
                    <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
                        ...
                        close Your web browser. You can learn more about cookies here: <a
                            href="https://www.termsfeed.com/blog/cookies/" target="_blank">All About Cookies by
                            TermsFeed</a>.</p>
                    ...
                    <ul>
                        <li>By email: support@edgejoint.com</li>
                    </ul>
                </div>
